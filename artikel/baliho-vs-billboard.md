---
article_id: RKT-03-01
title: "Baliho vs Billboard: Istilah dan Scope"
...
date_modified: null
parent_topic: RKT-03
primary_intent: "Clarify static outdoor formats"
...
# Baliho vs Billboard: Istilah dan Scope

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Baliho vs Billboard: Istilah dan Scope”
...
- **Primary intent:** Clarify static outdoor formats
...
- **Scope boundary:** Terminology/scope
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Baliho vs Billboard: Istilah dan Scope**.
...
- `/periklanan-baliho/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Baliho vs Billboard: Istilah dan Scope”.
