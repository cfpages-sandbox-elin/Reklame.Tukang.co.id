---
article_id: RKT-06-05
title: "Penempatan Logo dan Informasi Tenant"
slug: "layout-logo-tenant-signage"
description: "Choose huruf timbul, papan nama, and freestanding sign systems"
status: outline
publication_date: "2026-04-16"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RKT-06
primary_intent: "Plan content hierarchy"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/layout-logo-tenant-signage.html"
...
# Penempatan Logo dan Informasi Tenant

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Penempatan Logo dan Informasi Tenant”
- **Reader and situation:** Choose huruf timbul, papan nama, and freestanding sign systems
- **Reader outcome:** Choose huruf timbul, papan nama, and freestanding sign systems
- **Primary intent:** Plan content hierarchy
...
- **Scope boundary:** Wayfinding/brand only
- **Final public route:** `/artikel/layout-logo-tenant-signage.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Penempatan Logo dan Informasi Tenant**.
...
- `RKT-06-03` → `/artikel/papan-dinding-vs-projecting-sign.html` — Papan Nama Dinding vs Projecting Sign
- `RKT-06-04` → `/artikel/totem-monolith-vs-modular.html` — Totem Sign Monolith vs Modular
- `RKT-06-06` → `/artikel/checklist-shop-drawing-signage.html` — Checklist Shop Drawing Signage
...
- **Tie back to this article:** Keep the explanation specific to “Penempatan Logo dan Informasi Tenant”.
