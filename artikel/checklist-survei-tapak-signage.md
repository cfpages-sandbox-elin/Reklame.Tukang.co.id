---
article_id: RKT-02-04
title: "Survei Tapak Sebelum Memilih Signage"
slug: "checklist-survei-tapak-signage"
description: "Define message, viewing, placement, and constraints"
status: outline
publication_date: "2026-01-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: RKT-02
primary_intent: "Capture placement constraints"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/checklist-survei-tapak-signage.html"
...
# Survei Tapak Sebelum Memilih Signage

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survei Tapak Sebelum Memilih Signage”
- **Reader and situation:** Define message, viewing, placement, and constraints
- **Reader outcome:** Define message, viewing, placement, and constraints
- **Primary intent:** Capture placement constraints
...
- **Final public route:** `/artikel/checklist-survei-tapak-signage.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survei Tapak Sebelum Memilih Signage**.
...
- `RKT-02-02` → `/artikel/jarak-pandang-waktu-baca-signage.html` — Jarak Pandang dan Waktu Baca Signage
- `RKT-02-03` → `/artikel/hierarki-pesan-reklame.html` — Menentukan Hierarki Pesan Reklame
- `RKT-02-05` → `/artikel/cahaya-sekitar-signage.html` — Siang, Malam, dan Kondisi Cahaya Sekitar
- `RKT-02-06` → `/artikel/mockup-signage-pada-tapak.html` — Mockup Signage pada Foto Tapak
...
- **Tie back to this article:** Keep the explanation specific to “Survei Tapak Sebelum Memilih Signage”.
